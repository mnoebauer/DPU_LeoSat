...
async def mainFlightLogic():
    ...
    mainTasks.append(asyncio.create_task(transmission2.Transmission.send()))

    f = open('/home/pi/DPU_LeoSat/data/startaltitude.txt','r') #open startAltitude file in read mode
    ...
    while True:
        ...
        if rAltitude < 1000 or rAltitude > 34000:
            ...
            video = cameraObj.takeVideo()
            await asyncio.run(video)
            

        else:
            print("taking picture")
            picture = cameraObj.takePicture()
            await asyncio.run(picture)
...
async def bootLogic():
    ...
    f = open('/home/pi/DPU_LeoSat/data/bootcycles.txt','r') #opening the bootcycles file in read mode
    ...
    if int(bootnumber) == 0:
        ...
        f = open('/home/pi/DPU_LeoSat/data/startaltitude.txt','w')
